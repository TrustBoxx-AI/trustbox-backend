...
export const HEDERA_CONFIG = {
  ...
  topics: {
    ...
    auditTrail:       env.HCS_AUDIT_TOPIC_ID   ?? null,
    agentVerification:env.HCS_AGENT_TOPIC_ID   ?? null,
  },
  tokens: {
...
export const HOL_CONFIG = {
  registryTopicId: env.HOL_REGISTRY_TOPIC_ID   ?? null,
  inboxTopicId:    env.HCS10_INBOX_TOPIC_ID     ?? null,
  outboxTopicId:   env.HCS10_OUTBOX_TOPIC_ID    ?? null,
  agentId:         "trustbox-orchestrator",
  protocol:        "hcs-10",
  registryDocs:    "https://hol.org/registry/docs",
};
